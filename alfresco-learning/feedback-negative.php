<?php 
/*
 * Template Name:  Feedback Negative
...
<script type="text/javascript">
    ...
    function formSetup() {
        const form = document.querySelector('#alfresco_form-feedback-negative');
    ...
    function submitForm(event, form) {
        ...
        const url = '/wp-admin/admin-ajax.php?action=ALFRESCO_FEEDBACK_NEGATIVE';
...
<div id="rilee-content-container" class="rilee-single-page">
	<div class="rilee-container">
		<div id="rilee-content" class="rilee-full-width rilee_fullwidth_narrow">
            ...
            <div class="al_form">
                <form id="alfresco_form-feedback-negative">
