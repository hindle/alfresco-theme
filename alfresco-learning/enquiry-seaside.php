...
<script type="text/javascript">
    ...
    function formSetup() {
        const form = document.querySelector('#alfresco_form-workshop-seaside');
    ...
    function submitWorkshopForm(event, form) {
        ...
        const url = '/wp-admin/admin-ajax.php?action=ALFRESCO_WORKSHOP_SEASIDE';
...
<div id="rilee-content-container" class="rilee-single-page">
	<div class="rilee-container">
		<div id="rilee-content" class="rilee-full-width rilee_fullwidth_narrow">
            ...
            <div class="al_form">
                <form id="alfresco_form-workshop-seaside">
                    <h2>Contact</h2>
                    ...
                    <h2>Requirements</h2>
                    <div class="al_input-container">
                        <label for="outdoorTap">Outdoor tap</label><br>
                        <p><i>This workshop requires access to a working outdoor tap with a hose adaptor fitted, near to a flat open space where we can set up a small pool.</i></p>
                        <p><i>Please provide a summary of the tap and space that will be used for the workshop.</i></p>
                        <p><i>Please note, that booking this workshop without access to a working, outdoor tap with a hose adaptor for the pool, will result in the workshop not being delivered and your school still being charged.</i></p>
                        <textarea name="outdoorTap" id="outdoorTap" autocomplete="off" required></textarea><br>
                    </div>

                    <div class="al_input-container">
                        <label for="allergies">Allergies</label><br>
                        <p><i>This workshop involves handling real seaweed.</i></p>
                        <p><i>Please confirm that no adults or children attending the workshop have any allergies to fish, crustaceans or molluscs.</i></p>
                        <p><i>Please note, it is detailed in our risk assessment that nobody with an allergy to fish, crustaceans or molluscs can take part in the workshop.</i></p>
                        <textarea name="allergies" id="allergies" autocomplete="off" required></textarea><br>
                    </div>
