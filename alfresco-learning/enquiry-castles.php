...
<script type="text/javascript">
    ...
    function formSetup() {
        const form = document.querySelector('#alfresco_form-workshop-castles');
    ...
    function submitWorkshopForm(event, form) {
        ...
        const url = '/wp-admin/admin-ajax.php?action=ALFRESCO_WORKSHOP_CASTLES';
...
<div id="rilee-content-container" class="rilee-single-page">
	<div class="rilee-container">
		<div id="rilee-content" class="rilee-full-width rilee_fullwidth_narrow">
            ...
            <div class="al_form">
                <form id="alfresco_form-workshop-castles">
                    <h2>Contact</h2>
                    ...
                    <h2>Requirements</h2>
                    <div class="al_input-container">
                        <label for="flatSpace">Flat space</label><br>
                        <p><i>This workshop requires a flat, open outdoor space (to construct the castle on!).</i></p>
                        <p><i>Please provide a summary of the real grass space that will be used for the workshop.</i></p>
                        <p><i>Please note, that booking this workshop without access to a flat, open outdoor space, will result in the workshop not being delivered and your school still being charged.</i></p>
                        <textarea name="flatSpace" id="flatSpace" autocomplete="off" required></textarea><br>
                    </div>
