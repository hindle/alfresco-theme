...
<script type="text/javascript">
    ...
    function formSetup() {
        const form = document.querySelector('#alfresco_form-workshop-gfol');
    ...
    function submitWorkshopForm(event, form) {
        ...
        const url = '/wp-admin/admin-ajax.php?action=ALFRESCO_WORKSHOP_GFOL';
...
<div id="rilee-content-container" class="rilee-single-page">
	<div class="rilee-container">
		<div id="rilee-content" class="rilee-full-width rilee_fullwidth_narrow">
            ...
            <div class="al_form">
                <form id="alfresco_form-workshop-gfol">
                    <h2>Contact</h2>
                    ...
                    <h2>Requirements</h2>
                    <div class="al_input-container">
                        <label for="grassSpace">Grass space</label><br>
                        <p><i>This workshop requires real grass space to take place on.</i></p>
                        <p><i>Please provide a summary of the real grass space that will be used for the workshop.</i></p>
                        <p><i>Please note, that booking this workshop without access to a real grass space will result in the workshop not being delivered and school still being charged.</i></p>
                        <textarea name="grassSpace" id="grassSpace" autocomplete="off" required></textarea><br>
                    </div>
